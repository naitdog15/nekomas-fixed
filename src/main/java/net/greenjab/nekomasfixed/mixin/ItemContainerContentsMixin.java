 ...
 * text, the mod supplies its own" purpose this mixin served is moot rather than portable: as
 * ItemStackMixin's header notes, the mod's own replacement tooltip text/image for containers is not
 * implemented on this version yet.
 */
