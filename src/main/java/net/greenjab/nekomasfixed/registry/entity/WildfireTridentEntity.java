...
public class WildfireTridentEntity extends PersistentProjectileEntity {
	private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(WildfireTridentEntity.class, TrackedDataHandlerRegistry.BYTE);
	private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(WildfireTridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	private boolean dealtDamage = false;
	public int returnTimer;

	public WildfireTridentEntity(EntityType<? extends WildfireTridentEntity> entityType, World world) {
		super(entityType, world);
	}

	public WildfireTridentEntity(World world, LivingEntity owner, ItemStack stack) {
		super(EntityTypeRegistry.WILDFIRE_TRIDENT, owner, world, stack, null);
		this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
		this.dataTracker.set(ENCHANTED, stack.hasGlint());
	}

	public WildfireTridentEntity(World world, double x, double y, double z, ItemStack stack) {
