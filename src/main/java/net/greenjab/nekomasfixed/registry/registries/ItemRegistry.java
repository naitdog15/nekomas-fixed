...
public class ItemRegistry {
    ...
    public static final Item NETHER_HEART = register(
            "nether_heart", settings -> new SmithingTemplateItem(
                    ...
                    settings),new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant().component(DataComponents.DAMAGE_RESISTANT, new DamageResistant(DamageTypeTags.IS_EXPLOSION))
    );
    ...
    public static final Item JEWEL_ARMOR_TRIM_SMITHING_TEMPLATE = register("jewel_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant().component(DataComponents.DAMAGE_RESISTANT, new DamageResistant(DamageTypeTags.IS_EXPLOSION)));
    ...
    public static final Item CROWN_SMITHING_TEMPLATE = register("crown_smithing_template", settings ->
            new SmithingTemplateItem(Component.translatable(Util.makeDescriptionId("item", NekomasFixed.id("helmets")))
                    ...
                    List.of(NekomasFixed.id("container/slot/nether_heart")), settings),new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant().component(DataComponents.DAMAGE_RESISTANT, new DamageResistant(DamageTypeTags.IS_EXPLOSION)));
    ...
    public static DyeItem registerDye(String id, ModColors color) {
        return (DyeItem) register(keyOf(id), settings -> new ModDyeItems(color, settings), new Item.Properties());
    }
