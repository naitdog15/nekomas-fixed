...
/**
 * Frozen wire contract: four booleans, in the order below. Do not reorder, retype, add or remove a
...
public final class ConfigFlagsPayload {
    ...
    public static ConfigFlagsPayload decode(FriendlyByteBuf buf) {
        return new ConfigFlagsPayload(buf.readBoolean(), buf.readBoolean(),
    ...
    public void handle(Supplier<NetworkEvent.Context> ctxSupplier) {
        ...
        ctx.enqueueWork(() -> ServerFlags.fromServer(turtleArmourAbilities, offhandAttack,
                featherKnockback, featherFallingSavesCrops));
